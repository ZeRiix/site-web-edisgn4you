	...
	<?php // include('log/log.php');?>
		...
		<main>
            ...
            <div class="container-fluid" id="container-connexion">
                ...
                <form action="verif_connexion.php" class="container-fluid" id="container-email" method="post">
                    <div class="mb-3">
                    ...
                    <div style="text-align: center">Envie de nous rejoindre ? <a href="inscription.php" style="text-decoration: none"><strong>Créer un Compte</strong></a></div>
