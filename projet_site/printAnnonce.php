...
if (!empty($id)) {
    $reqadver = $bdd->prepare("SELECT * FROM annonces WHERE id = ?");
...
?>
<html>
<?php $namePage = 'Annonce de ' . $t['pseudo']; include('includes/head.php'); ?>
<?php include('log.php'); ?>
        ...
        <div class="container-fluid" id="row-annoncereduite">
            <div class="row" id="row-annoncereduite">
                ...
                <div class="col-xl-5" id="container-annoncerdy2">
                    <h1>Annonce créée par <?php echo $t['pseudo']; ?></h1>
                ...
                <div class="col-xl-4" id="divcom">
                    <?php if (isset($_SESSION['id'])) { if ($t['idcrea'] != $_SESSION['id']) {?>
                    <div class="container-fluid" id="divform">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <label>Contenu</label>
                            <br>
                            <textarea type="text" name="comment" class="contenucom"
                                placeholder="Contenu du commentaire"></textarea>
                            <br>
                            <div class="spacer10" id="spacer10"></div>
                            <input type="submit" value="Envoyer" name="formComment" class="btn btn-secondary"
                                id="boutoncom">
                        </form>
                    </div>
                    <?php
