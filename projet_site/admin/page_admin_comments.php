...
$commentairesList = $bdd->query('SELECT * FROM commentaires ORDER BY id');
?>
                    ...
                    <div class="coloneAdmin" align="center">
                        <ul>
                            <?php while($c = $commentaires->fetch()) { ?>
                                <li><?= $c['pseudo'] ?> : <?= $c['title'] ?> : <?= $c['contenu'] ?>- <a href="page_admin_comments.php?type=commentaire&supprime=<?= $c['id'] ?>">Supprimer</a></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
