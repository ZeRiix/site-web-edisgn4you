...
$tableCo = array("connexionPro.php", "connexionPro.php", "connexionPro.php", "connexionPro.php", "connexionPro.php", "connexionPro.php", "connexionPro.php", "connexionPro.php", "connexionPro.php");
// print_r($table);
$intru = "image_captcha/intru.jpg";
$intruCo = "profilPro.php?id=" . $_SESSION['id'];
$table[$rand] = $intru;
