...
if(isset($_SESSION['id'])) {
    ...
    if (isset($_POST['submitprofil'])) {
        ...
        if(isset($_POST['surname']) AND !empty($_POST['surname']) AND $_POST['surname'] != $user['nom']) {
            ...
            $insertsurname = $bdd->prepare("UPDATE membrespro SET nom = ? WHERE id = ?");
        ...
        if(isset($_POST['num']) AND !empty($_POST['num']) AND $_POST['num'] != $user['num']) {
            ...
            $insertnum = $bdd->prepare("UPDATE membrespro SET num = ? WHERE id = ?");
        ...
        if(isset($_POST['description']) AND !empty($_POST['description']) AND $_POST['description'] != $user['descriptions']) {
            ...
            $insertdescription = $bdd->prepare("UPDATE membrespro SET descriptions = ? WHERE id = ?");
        ...
        if(isset($_FILES['avatar']) AND !empty($_FILES['avatar']['name'])) {
            ...
            if($_FILES['avatar']['size'] <= $tailleMax) {
               ...
               if(in_array($extensionUpload, $extensionsValides)) {
                  ...
                  if($resultat) {
                     $updateavatar = $bdd->prepare('UPDATE membrespro SET avatar = :avatar WHERE id = :id');
            ...
            <div class="row" id="row-pageprofil">
                    ...
                    <div class="profil-card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8" id="row-localisation">
                                <h2>Habite en <?php echo $user['pays']?></h2>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8" id="row-date">
                                <h2>Membre depuis <?php echo $user['date_crea']?></h2>
                            </div>
                            <div class="col-xl-3" id="row-date">
                                <h3>Date</h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-8">
                    <div class="row" id="row-formprofil">
                        ...
                        <div class="spacer20" id="spacer20"></div>
                        <?php
                        echo '<a href="profilPro.php?id=' . $_SESSION['id'] . '" class="btn btn-primary">retour profil</a>';
                        ?>
                    </div>
                </div>
            </div>
